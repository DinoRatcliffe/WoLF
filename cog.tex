...
\begin{figure*}
    \centering
    \includegraphics[width=16.99em]{Figures/matching-pennies-lr-1e-2.png}
    \includegraphics[width=16.99em]{Figures/matching-pennies-lr-1e-1.png}
    \includegraphics[width=16.99em]{Figures/weighted-matching-pennies-lr-1e-2.png}
    \caption{\TODO{have better solution for this}}
    \label{fig:mp-ppo-e2}
\end{figure*}
...
\begin{figure*}
    \centering
    \includegraphics[width=16.99em]{Figures/rock-paper-scissors-lr-1e-2}
    \includegraphics[width=16.99em]{Figures/rock-paper-scissors-lr-1e-1}
    \includegraphics[width=16.99em]{Figures/rock-paper-scissors-lr-1e-1}
    \caption{\TODO{have better solution for this}}
    \label{fig:rps-ppo-e2}
\end{figure*}
