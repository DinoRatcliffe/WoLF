...
\begin{figure*}[htbp]
    \subfloat[Standard MP, Small learning rate, Note the scale of the y axis.\label{fig:standard-mp-e2}]{\includegraphics[height=1.8in]{Figures/matching-pennies-lr-1e-2}}
\subfloat[Standard MP, Large learning rate\label{fig:standard-mp-e1}]{\includegraphics[height=1.8in]{Figures/matching-pennies-lr-1e-1}}
...
\begin{figure*}[htbp]
    \subfloat[Standard RPS, Small learning rate, note the scale of the y axis.\label{fig:standard-rps-e2}]{\includegraphics[height=1.8in]{Figures/rock-paper-scissors-lr-1e-2}}
...
For all of our experiments we used a ratio of $4$ between our winning and losing learning rates where $\alpha_{LOSE} = 4\alpha_{WIN}$. The network used for all experiments is a fully connected feed forward neural network, with two hidden layers of $20$ neurons.
