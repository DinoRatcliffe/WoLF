...
\begin{figure*}[htbp]
    \subfloat[Standard RPS, Small learning rate, note the scale of the axes.\label{fig:standard-rps-e2}]{\includegraphics[height=1.8in]{Figures/rock-paper-scissors-lr-1e-2}}
