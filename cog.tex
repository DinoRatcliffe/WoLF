...
\begin{figure*}[htbp]
\subfloat[Small learning rate, $NES = 0.50$]{\includegraphics[height=1.8in]{Figures/matching-pennies-lr-1e-2}}
\subfloat[Large learning rate, $NES = 0.50$]{\includegraphics[height=1.8in]{Figures/matching-pennies-lr-1e-1}}
\subfloat[Small learning rate, $NES = 0.40$]{\includegraphics[height=1.8in]{Figures/weighted-matching-pennies-lr-1e-2}}
...
\begin{figure*}[htbp]
    \subfloat[Standard RPS, Small learning rate]{\includegraphics[height=1.8in]{Figures/rock-paper-scissors-lr-1e-2}}
\subfloat[Standard RPS, Large learning rate]{\includegraphics[height=1.8in]{Figures/rock-paper-scissors-lr-1e-1}}
\subfloat[Weighted RPS, Large learning rate]{\includegraphics[height=1.8in]{Figures/weighted-rock-paper-scissors-lr-1e-1}}
...
We then ran PPO and WoLF-PPO on a weighted version of Rock Paper Scissors. This is to move the NES away from the max entropy policy. In Fig \ref{fig:weighted-rps-ppo-e2} we show that in this environment WoLF-PPO stays closer to the NES than PPO. This is consistent with the matching pennies results.
